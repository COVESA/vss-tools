...
try:
    ...
    print (f"Potentially not all contrib exporter functional because of missing dependency: {e.msg}")
...
def main(arguments):
    ...
    for entry in Exporter:
        ...
        if None != entry.value:
            ...
            print (f"Contrib exporter {entry.name} not supported due to missing dependencies.")
