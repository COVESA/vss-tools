...
#   <Signal>.msg               -> one stamped sample (existing)
#   <Signal>Timeseries.msg     -> windowed batch of stamped samples (new)
#   Get<Signal>Timeseries.srv  -> batch retrieval over a time window (new)
#   Set<Signal>Timeseries.srv  -> batch injection (new)
#
...
def render_timeseries_msg(
    ...
    """Render a <Signal>Timeseries.msg containing window metadata + a variable-length
...
def render_get_timeseries_srv(
    ...
    """Render Get<Signal>Timeseries.srv.
...
def render_set_timeseries_srv(base_msg_name: str) -> str:
    """Render Set<Signal>Timeseries.srv.
