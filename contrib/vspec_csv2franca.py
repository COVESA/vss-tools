...
def usage():
    ...
    print("  -s signals           Pattern for signals to include (mandatory, can be repeated). Case sensitive. Explicit full name or use * for wildcard.")
    print("  -v version           Specify VSS interface version (should match the used VSS version)")
